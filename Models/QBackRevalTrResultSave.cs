...
public partial class QBackRevalTrResultSave
{
    public double? SgpaBackReval { get; set; }

    public int? TotalMarksFinalCalculated { get; set; }

    public double? SumOfEarnedCreditbackReval { get; set; }

    public double? SumOfGradePointsBackReval { get; set; }

    public string SubjectWisebackRevalResult { get; set; } = null!;

    public double? BacklogMarksTotal { get; set; }

    public double? SgpaBacklog { get; set; }

    public double? TotalMarksFinal { get; set; }

    public double? SumofcredetpointInExamTow { get; set; }

    public double? EarnedCreditBacklog { get; set; }
    ...
    public double? ModeratedSumOfCreditPointsBacklog { get; set; }

    public string? SubWiseResultBacklog { get; set; }

    public string? FinalResultBacklog { get; set; }

    public bool? IsBacklog { get; set; }

    public double? ExamMarksBackRevalExam { get; set; }

    public double? BackRevalExamMarksTheory { get; set; }

    public bool? IsBackReval { get; set; }

    public double? BackRevalMarksCalc { get; set; }

    public bool? IsAbsentThreExam { get; set; }

    public double? Condo { get; set; }

    public bool? IsBackRevaluation { get; set; }

    public bool? BackRevalThabsent { get; set; }

    public double? AppliedGraceInBacklogReval { get; set; }

    public double? AppliedCondoInBacklogReval { get; set; }

    public double? FinalBacklogCalcReval { get; set; }

    public string? FinalResultBacklog1 { get; set; }

    public string? GradeBackReval { get; set; }

    public double? CreditpointBackReval { get; set; }

    public double? EarnedCreditsForSubBackReval { get; set; }

    public double? BacklogMarksTotalReval { get; set; }
}
