...
public partial class QBackRevalTrResult
{
    ...
    public int AppliedGraceInBacklogReval { get; set; }

    public double? AppliedCondoInBacklogReval { get; set; }

    public double? FinalBacklogCalcReval { get; set; }

    public string FinalResultBacklog1 { get; set; } = null!;

    public string GradeBackReval { get; set; } = null!;
