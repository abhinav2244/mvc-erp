...
public partial class QStudentwiseFinalResultFinalGradeResultTwoReassesment
{
    ...
    public bool IsAbsentThextReass { get; set; }

    public bool IsAbsentPrextReass { get; set; }
