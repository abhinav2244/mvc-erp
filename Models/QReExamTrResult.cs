...
public partial class QReExamTrResult
{
    public int? TotalMarksFinal { get; set; }

    public decimal? SumofcredetpointInExamTow { get; set; }
    ...
    public double? SumofcredetpointInExam { get; set; }
    ...
    public int? AppliedGraceInReexam { get; set; }

    public int? AppliedCondoInReexam { get; set; }

    public double? FinalReExamMarksCalc { get; set; }
    ...
    public int? EarnedCreditsForSubReExam { get; set; }

    public double? ModeratedSumOfCreditPointsReExam { get; set; }

    public double? ReExamMarksTotal { get; set; }

    public double? SgpaReExam { get; set; }

    public double? EarnedCreditReExam { get; set; }
}
