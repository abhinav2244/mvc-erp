...
public partial class BackRevalExamResult
{
    public double? BackRevalMarksTotal { get; set; }

    public double? SgpaBackreval { get; set; }

    public double? TotalMarksFinalCalculated { get; set; }

    public double? SumofcredetpointInBackExamTow { get; set; }

    public double? EarnedCreditbackReval { get; set; }
    ...
    public double? ExamSubjectId1 { get; set; }

    public double? ExamSubjectId2 { get; set; }
    ...
    public string? ResultBackReval { get; set; }

    public string? FinalResultBackReval { get; set; }

    public string? GradeBackReval { get; set; }

    public double? CreditpointBackReval { get; set; }

    public double? TotalMarksOne { get; set; }

    public double? EarnedCreditsForSubBackReval { get; set; }

    public double? ModeratedSumOfCreditPointsBackReval { get; set; }
}
